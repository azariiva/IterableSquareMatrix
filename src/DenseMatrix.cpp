...
// {
//     m_matrix = new T*[SquareMatrix::num_rows];
//     for (size_t i = 0; i < SquareMatrix::num_rows; ++i)
//         m_matrix[i] = new T[SquareMatrix::num_columns];
// }

// template <typename T>
// DenseMatrix<T>::DenseMatrix(const DenseMatrix& m) : SquareMatrix(m.m_num_rows, m.m_num_columns)
// {
//     m_matrix = new T*[SquareMatrix::m_num_rows];
//     for (size_t i = 0; i < SquareMatrix::m_num_rows; ++i)
//     {
//         m_matrix[i] = new T[SquareMatrix::m_num_columns];
...
// template <typename T>
// void DenseMatrix<T>::set(size_t row, size_t column, const T& value)
// {
//     if (row >= SquareMatrix::m_num_rows || column >= SquareMatrix::m_num_columns)
//         throw std::out_of_range("out of bounds exception (num_rows or num_columns exceeded)");
...
// {
//     if (SquareMatrix::m_num_rows != m.m_num_rows || SquareMatrix::m_num_columns != m.m_num_columns)
//         return false;
//     for (size_t i = 0; i < SquareMatrix::m_num_rows; ++i)
//         for (size_t j = 0; j < SquareMatrix::m_num_columns; ++j)
